...
def main():
    ...
    ## Color print in BGR
    print_color = {"Green": (0, 255, 0),"Purple": (255, 0, 255),"Yellow": (0, 200, 255),"Blue": (255, 135, 0),"White": (255, 255, 255)}
    print_compl_color = {"Green": (0, 0, 255),"Purple": (0, 255, 255),"Yellow": (255, 120, 175),"Blue": (0, 135, 255),"White": (0, 0, 0)}
